...
| `seed/0001_pilot_postpartum_confinement.sql` | Pilot slice data (postpartum confinement across US/EU/CN/AU). Structured records only — embeddings are generated by the pipeline, not seeded. |
